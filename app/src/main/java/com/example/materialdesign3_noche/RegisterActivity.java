...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void configurarCampos(){
        ...
        myDate.addOnPositiveButtonClickListener( selection -> {
            TimeZone timeZoneUTC = TimeZone.getDefault();
            int offsetFromUTC = timeZoneUTC.getOffset(new Date().getTime()) * -1;
            Date fecha = new Date(Long.valueOf(selection.toString()) + offsetFromUTC);
    ...
    public class Validacion {
        ...
        public Validacion(TextInputEditText campo, String expresion, int min, int max, TextInputLayout campoError, boolean requerido){
            ...
            //Mostrarmos el contador de caracterres
            this.campoError.setCounterEnabled(true);
            this.campoError.setCounterMaxLength(max);
        ...
        public void ocultaError(){
            ...
            int endIconMode = campoError.getEndIconMode();
            if(endIconMode != TextInputLayout.END_ICON_PASSWORD_TOGGLE && this.requerido )
